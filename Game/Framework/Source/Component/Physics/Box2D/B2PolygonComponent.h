...
public:
	...
	void onCreate(const std::weak_ptr<Entity>& world, bool isStatic, const std::vector<XMFLOAT3>& vertexes);
...
private:
	void createBody(const std::weak_ptr<Entity>& world, bool isStatic, const std::vector<XMFLOAT3>& vertexes);
	b2Body* m_body;
