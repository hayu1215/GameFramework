...
PolygonShader::PolygonShader(const std::string& name)
{
	try
	{
		load(name);
...
void PolygonShader::load(const std::string& name)
{
	...
	D3D11_INPUT_ELEMENT_DESC layout[] =
	{
		...
		{ "OFFSET", 1, DXGI_FORMAT_R32G32B32_FLOAT, 1, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
		{ "OFFSET", 2, DXGI_FORMAT_R32G32B32_FLOAT, 1, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
		{ "OFFSET", 3, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
	};
