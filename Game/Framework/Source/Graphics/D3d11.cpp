...
ID3D11Buffer * D3d11::CreateVertexBuffer(unsigned int size, void * data) {
    ID3D11Buffer* buffer;
    ...
    if (data != nullptr) {
        ...
        auto result = D3d11::Device()->CreateBuffer(&desc, &initData, &buffer);
        utility::CheckError(result, "インデックスバッファーの作成失敗");
    } else {
        auto result = D3d11::Device()->CreateBuffer(&desc, nullptr, &buffer);
        utility::CheckError(result, "インデックスバッファーの作成失敗");
    }
    return buffer;
}

ID3D11Buffer * D3d11::CreateIndexBuffer(unsigned int size, void * data) {
    ID3D11Buffer* buffer;
    D3D11_BUFFER_DESC desc;
    desc.Usage = D3D11_USAGE_DEFAULT;
...
//ComPtr<ID3D11Buffer> D3d11::CreateVertexBuffer(unsigned int size, void * data)
//{
...
//		initData.pSysMem = &data;
//		initData.SysMemPitch = desc.ByteWidth;
//		auto result = D3d11::Device()->CreateBuffer(&desc, &initData, res.GetAddressOf());
//		utility::CheckError(result, "インデックスバッファーの作成失敗");
//	}
//	else
//	{
//		auto result = D3d11::Device()->CreateBuffer(&desc, nullptr, res.GetAddressOf());
//		utility::CheckError(result, "インデックスバッファーの作成失敗");
//	}
//	return res;
//}
//
//ComPtr<ID3D11Buffer> D3d11::CreateIndexBuffer(unsigned int size, void * data)
//{
//	ComPtr<ID3D11Buffer> res;
//	D3D11_BUFFER_DESC desc;
//	desc.Usage = D3D11_USAGE_DEFAULT;
//	desc.BindFlags = D3D11_BIND_INDEX_BUFFER;
//	desc.ByteWidth = sizeof(size);
//	desc.CPUAccessFlags = 0;
//	desc.MiscFlags = 0;
//	if (data != nullptr)
//	{
...
//void D3d11::CreateVertexBuffer(unsigned int size, ID3D11Buffer** buffer, void* data)
//{
//	D3D11_BUFFER_DESC desc;
//	desc.Usage = D3D11_USAGE_DEFAULT;
//	desc.BindFlags = D3D11_BIND_VERTEX_BUFFER;
...
//}
//
//void D3d11::CreateIndexBuffer(unsigned int size, ID3D11Buffer** buffer, void* data)
//{
//	D3D11_BUFFER_DESC desc;
//	desc.Usage = D3D11_USAGE_DEFAULT;
//	desc.BindFlags = D3D11_BIND_INDEX_BUFFER;
