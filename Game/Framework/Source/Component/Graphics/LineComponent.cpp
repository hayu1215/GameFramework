...
void LineComponent::onCreate(const std::vector<XMFLOAT3>& positions, const XMFLOAT4& color,
                             float width, bool isLoop) {
...
void LineComponent::setLine(const std::vector<XMFLOAT3>& positions, const XMFLOAT4& color,
                            float width, bool isLoop) {
